...
data = pd.read_excel('./perceptual_results/results_preliminary_with_manual_corrections.xlsx')
...
data.to_excel('./perceptual_results/results_preliminary_with_wer.xlsx', index=False)
